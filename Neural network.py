import numpy as np
data_train = np.loadtxt(r"C:\Users\SHREYAS TYAGI\Downloads\mnist_train.csv\mnist_train.csv", delimiter=",", skiprows=1)
...
data_test = np.loadtxt(r"C:\Users\SHREYAS TYAGI\OneDrive\Desktop\codes\mnist_test.csv", delimiter=",", skiprows=1)
